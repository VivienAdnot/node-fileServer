    ...
    return function e(t, n, r) {
            ...
            var p = e("./ReactComponent"),
                ...
                L = {
                    ...
                    updateComponent: E.measure("ReactCompositeComponent", "updateComponent", function(e, t) {
                        ...
                        if (w(r, o)) n.receiveComponent(o, e);
                        else {
                ...
                _createOpenTagMarkupAndPutListeners: function(e) {
                    ...
                    for (var o in t)
                        if (t.hasOwnProperty(o)) {
                            var i = t[o];
                            if (null != i)
                                if (R.hasOwnProperty(o)) r(this._rootNodeID, o, i, e);
                                else {
                ...
                _updateDOMProperties: function(e, t) {
                    ...
                    for (n in e)
                        if (!a.hasOwnProperty(n) && e.hasOwnProperty(n))
                            ...
                            } else R.hasOwnProperty(n) ? E(this._rootNodeID, n) : (s.isStandardName[n] || s.isCustomAttribute(n)) && l.BackendIDOperations.deletePropertyByID(this._rootNodeID, n);
                    for (n in a) {
                        var c = a[n],
                            p = e[n];
                        ...
                        else R.hasOwnProperty(n) ? r(this._rootNodeID, n, c, t) : (s.isStandardName[n] || s.isCustomAttribute(n)) && l.BackendIDOperations.updatePropertyByID(this._rootNodeID, n, c)
                    }
                ...
                I = {
                    ...
                    render: function(e, t, r) {
                        ...
                        if (o) {
                            ...
                            if (M(i, e)) return I._updateRootComponent(o, e, t, r);
                    ...
                    unmountComponentFromNode: function(e, t) {
                        for (e.unmountComponent(), t.nodeType === T && (t = t.documentElement); t.lastChild;) t.removeChild(t.lastChild)
                    },
                ...
                s = n.createClass({
                    ...
                    render: function() {
                        ...
                        for (var t in this.state.children) {
                            ...
                            r && (e[t] = i(this.props.childFactory(r), {
                                ref: t
                            }))
                        }
                    ...
                    if (Array.isArray(e))
                        for (var m = 0; m < e.length; m++) {
                            ...
                            var y = typeof e,
                                g = "" === t,
                                E = g ? l + r(e, 0) : t;
                            if (null == e || "boolean" === y) o(a, null, E, n), f = 1;
                            else if ("string" === y || "number" === y || s.isValidElement(e)) o(a, e, E, n), f = 1;
                            else if ("object" === y) {
                                c(!e || 1 !== e.nodeType);
        ...
        154: [function(e, t) {
            ...
            function o(e, t) {
                ...
                for (var v in t) m.hasOwnProperty(v) && m[v] || (a[v] = o(e[v], t[v]));
                return a
            }
